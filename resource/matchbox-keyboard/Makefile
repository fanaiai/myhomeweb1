...
DATA = $(dist_desktop_DATA) $(dist_pixmaps_DATA)
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = src layouts examples gtk-im applet
...
abs_builddir = /home/pi/matchbox-keyboard
abs_srcdir = /home/pi/matchbox-keyboard
...
top_builddir = .
top_srcdir = .
SUBDIRS = src layouts $(am__append_1) $(am__append_2) $(am__append_3)
...
install-data-am: install-dist_desktopDATA install-dist_pixmapsDATA
...
uninstall-am: uninstall-dist_desktopDATA uninstall-dist_pixmapsDATA
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-dist_desktopDATA install-dist_pixmapsDATA install-dvi \
	...
	uninstall-dist_desktopDATA uninstall-dist_pixmapsDATA
